...
5. [how-to-connect-db-from-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-connect-db-from-spring)
6. [what-is-spring-actuators](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
7. [map-vs-flatmap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
8. [what-is-spring-global-exception](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
9. [-what-is-azure-function](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
10. [what-is-azure-kubernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
11. [what-is-responsive-ui-in-js](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
12. [what-is-serverless-computing](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
13. [what-is-java-steams](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
14. [what-factory-class-java-having](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
15. [flow-of-spring-mvc](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
16. [how-you-test-json-implementation](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
17. [-can-mutable-object-is-instance-of-immutable-class-how-to-fix](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
18. [what-is-saas](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
19. [how-to-handle-transactions-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
20. [explain-transactions-in-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
21. [what-are-restful-annotations](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
22. [write-code-to-hit-new-api-request-from-your-code](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
23. [what-db-model-is-prefered-in-microservice-architecture](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
24. [what-is-autowire-usage](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
25. [explain-how-to-create-user-defined-annotations-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
26. [what-data-structure-does-executer-service-hold](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
27. [what-are-microservices-design-patterns](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
28. [sql-queries-with-functions--stored-procedures](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
29. [basic-packages-requires-to-create-spring-boot-application](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
30. [explain-spring-security](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
31. [explain-dirty---hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
32. [why-string-immutable-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
33. [how-to-configure-spring--hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
34. [what-is-class-not-found-and-no-class-def-error](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
35. [is-static-method-override-possible](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
36. [explain-saveupdate-save-and-persist-methods](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
37. [how-to-convert-data-in-rest-response-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
38. [when-to-used-native-query--hibernate-query](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
39. [what-is-criteria-in-hibernate-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
40. [why-jquery-over-javascript-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
41. [what-is-bootstrap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
42. [what-is-service-layer-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
43. [do-we-need-dao-layer-if-we-have-service-layer](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
44. [string-vs-string-builder](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
45. [what-is-docker](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
46. [how-to-configure-cicd-process](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
47. [how-to-avoid-sql-injection](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
48. [how-to-configure-techniques-of-jvm](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
49. [why-serialize-a-object-how-to-serialize-and-deserialize-object](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
50. [what-is-default-spring-bean-status](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
51. [what-is-states-of-hibernate-attribute](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
52. [why-concurrent-hashmap-used](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
53. [sort-hashmap-on-basis-of-value](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
54. [-linkedhashmap-internal-works](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
55. [what-is-weak-hashmap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
56. [how-you-validate-the-request-param-and-path-param-done-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
57. [what-is-reflaction-api-javalangreflect](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
58. [at-what-timeplace-rollback-gets-called](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
59. [what-are-different-types-of-class-loader](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
60. [how-to-convert-monolithic-application-to-microservices](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
61. [garbage-collectors-what-are-diff-types-of-garbage-collector-different-method-of-garbage-collector](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
62. [jdbc-versus-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
63. [explain-mappedby](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
64. [explain-hibernate-caching-how-to-configure-ehcache](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
65. [explain-bean-lifecycle](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
66. [mqs](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
67. [explain-maven-in-detail-explain-pomxml-in-detail](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
68. [why-to-overide-run-in-springapplication](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
69. [try-with-resources-vs-try-with-finally](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
70. [function-vs-bifunction](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
71. [mapping-vs-flat-mapping](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
72. [what-are-design-principles](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
73. [explain-stackoverflow-vs-oom](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
74. [explain-microservice-framework-netflix](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
75. [difference-between-primary--qualifier](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
76. [controller-vs-rest-controlled](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
77. [spring-actuators](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
78. [explain-hibernate-inheritance](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
79. [why-microservices](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
80. [how-to-manage-two-different-session-factory-transaction](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
81. [-what-are-different-library-for-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
82. [what-function-is-java-8-filter-backend](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
83. [where-vs-having-in-sql](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
84. [why-overloading-and-over-loading-concept](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
85. [is-synchronized-block-entire-object](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)

### Self: [self](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
1. [how-you-identify-which-asset-type](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
2. [test-your-application](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
3. [how-to-process-10000-request-handling-at-once--persist-in-db-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
4. [load-a-big-trnsactional-file-and-fetch-the-trnasction-records-using-best-data-structures](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
5. [how-to-load-balance-in-60-40-weightage-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-thread-with-caching)
