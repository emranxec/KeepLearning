...
3. [design-patterns-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-design-patterns-in-spring)
4. [how-to-connect-db-from-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-connect-db-from-spring)
5. [what-is-spring-actuators](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-spring-actuators)
6. [map-vs-flatmap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-map-vs-flatmap)
7. [what-is-spring-global-exception](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-spring-global-exception)
8. [what-is-azure-function](https://github.com/emranxec/KeepLearning/blob/main/README.md#q--what-is-azure-function)
9. [what-is-azure-kubernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-azure-kubernate)
10. [what-is-responsive-ui-in-js](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-responsive-ui-in-js)
11. [what-is-serverless-computing](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-serverless-computing)
12. [what-is-java-steams](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-java-steams)
13. [what-factory-class-java-having](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-factory-class-java-having)
14. [flow-of-spring-mvc](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-flow-of-spring-mvc)
15. [how-you-test-json-implementation](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-you-test-json-implementation)
16. [can-mutable-object-is-instance-of-immutable-class-how-to-fix](https://github.com/emranxec/KeepLearning/blob/main/README.md#q--can-mutable-object-is-instance-of-immutable-class-how-to-fix)
17. [what-is-saas](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-saas)
18. [how-to-handle-transactions-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-handle-transactions-in-spring)
19. [explain-transactions-in-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-transactions-in-hibernate)
20. [what-are-restful-annotations](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-restful-annotations)
21. [write-code-to-hit-new-api-request-from-your-code](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-write-code-to-hit-new-api-request-from-your-code)
22. [what-db-model-is-prefered-in-microservice-architecture](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-db-model-is-prefered-in-microservice-architecture)
23. [what-is-autowire-usage](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-autowire-usage)
24. [explain-how-to-create-user-defined-annotations-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-how-to-create-user-defined-annotations-)
25. [what-data-structure-does-executer-service-hold](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-data-structure-does-executer-service-hold)
26. [what-are-microservices-design-patterns](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-microservices-design-patterns)
27. [sql-queries-with-functions--stored-procedures](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-sql-queries-with-functions--stored-procedures)
28. [basic-packages-requires-to-create-spring-boot-application](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-basic-packages-requires-to-create-spring-boot-application)
29. [explain-spring-security](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-spring-security)
30. [explain-dirty---hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-dirty---hibernate)
31. [why-string-immutable-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-string-immutable-)
32. [how-to-configure-spring--hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-configure-spring--hibernate)
33. [what-is-class-not-found-and-no-class-def-error](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-class-not-found-and-no-class-def-error)
34. [is-static-method-override-possible](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-is-static-method-override-possible)
35. [explain-saveupdate-save-and-persist-methods](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-saveupdate-save-and-persist-methods)
36. [how-to-convert-data-in-rest-response-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-convert-data-in-rest-response-in-spring)
37. [when-to-used-native-query--hibernate-query](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-when-to-used-native-query--hibernate-query)
38. [what-is-criteria-in-hibernate-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-criteria-in-hibernate-)
39. [why-jquery-over-javascript-](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-jquery-over-javascript-)
40. [what-is-bootstrap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-bootstrap)
41. [what-is-service-layer-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-service-layer-in-spring)
42. [do-we-need-dao-layer-if-we-have-service-layer](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-do-we-need-dao-layer-if-we-have-service-layer)
43. [string-vs-string-builder](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-string-vs-string-builder)
44. [what-is-docker](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-docker)
45. [how-to-configure-cicd-process](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-configure-cicd-process)
46. [how-to-avoid-sql-injection](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-avoid-sql-injection)
47. [how-to-configure-techniques-of-jvm](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-configure-techniques-of-jvm)
48. [why-serialize-a-object-how-to-serialize-and-deserialize-object](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-serialize-a-object-how-to-serialize-and-deserialize-object)
49. [what-is-default-spring-bean-status](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-default-spring-bean-status)
50. [what-is-states-of-hibernate-attribute](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-states-of-hibernate-attribute)
51. [why-concurrent-hashmap-used](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-concurrent-hashmap-used)
52. [sort-hashmap-on-basis-of-value](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-sort-hashmap-on-basis-of-value)
53. [-linkedhashmap-internal-works](https://github.com/emranxec/KeepLearning/blob/main/README.md#q--linkedhashmap-internal-works)
54. [what-is-weak-hashmap](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-weak-hashmap)
55. [how-you-validate-the-request-param-and-path-param-done-in-spring](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-you-validate-the-request-param-and-path-param-done-in-spring)
56. [what-is-reflaction-api-javalangreflect](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-reflaction-api-javalangreflect)
57. [at-what-timeplace-rollback-gets-called](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-at-what-timeplace-rollback-gets-called)
58. [what-are-different-types-of-class-loader](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-different-types-of-class-loader)
59. [how-to-convert-monolithic-application-to-microservices](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-convert-monolithic-application-to-microservices)
60. [garbage-collectors-what-are-diff-types-of-garbage-collector-different-method-of-garbage-collector](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-garbage-collectors-what-are-diff-types-of-garbage-collector-different-method-of-garbage-collector)
61. [jdbc-versus-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-jdbc-versus-hibernate)
62. [explain-mappedby](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-mappedby)
63. [explain-hibernate-caching-how-to-configure-ehcache](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-hibernate-caching-how-to-configure-ehcache)
64. [explain-bean-lifecycle](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-bean-lifecycle)
65. [mqs](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-mqs)
66. [explain-maven-in-detail-explain-pomxml-in-detail](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-maven-in-detail-explain-pomxml-in-detail)
67. [why-to-overide-run-in-springapplication](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-to-overide-run-in-springapplication)
68. [try-with-resources-vs-try-with-finally](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-try-with-resources-vs-try-with-finally)
69. [function-vs-bifunction](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-function-vs-bifunction)
70. [mapping-vs-flat-mapping](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-mapping-vs-flat-mapping)
71. [what-are-design-principles](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-design-principles)
72. [explain-stackoverflow-vs-oom](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-stackoverflow-vs-oom)
73. [explain-microservice-framework-netflix](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-microservice-framework-netflix)
74. [difference-between-primary--qualifier](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-difference-between-primary--qualifier)
75. [controller-vs-rest-controlled](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-controller-vs-rest-controlled)
76. [spring-actuators](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-spring-actuators)
77. [explain-hibernate-inheritance](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-explain-hibernate-inheritance)
78. [why-microservices](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-microservices)
79. [how-to-manage-two-different-session-factory-transaction](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-manage-two-different-session-factory-transaction)
80. [what-are-different-library-for-hibernate](https://github.com/emranxec/KeepLearning/blob/main/README.md#q--what-are-different-library-for-hibernate)
81. [what-function-is-java-8-filter-backend](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-function-is-java-8-filter-backend)
82. [where-vs-having-in-sql](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-where-vs-having-in-sql)
83. [why-overloading-and-over-loading-concept](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-overloading-and-over-loading-concept)
84. [is-synchronized-block-entire-object](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-is-synchronized-block-entire-object)
85. [why-spring-boot](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-spring-boot)
86. [how-to-configure-profile-in-spring-boot](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-to-configure-profile-in-spring-boot)
87. [git-rebase-vs-git-merge-which-is-better](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-git-rebase-vs-git-merge-which-is-better)
88. [what-is-difference-between-primary-key-and-unique-key](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-difference-between-primary-key-and-unique-key)
89. [why-do-we-need-indexing-on-database-table-columns](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-why-do-we-need-indexing-on-database-table-columns)
90. [nth-highest-age](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-would-you-fetch-employee-with-nth-highest-age-from-employee-table-using-sql)
91. [what-is-difference-between-drop-truncate-and-delete-commands-in-sql](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-difference-between-drop-truncate-and-delete-commands-in-sql)
92. [what-are-clustered-and-non-clustered-indexes-in-database](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-clustered-and-non-clustered-indexes-in-database)
93. [onetomany-and-manytomany](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-onetoone-onetomany-and-manytomany-relationship-mappings-in-database-design)
94. [hibernate-optimal-usage-of-memory-network-and-cpu](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-how-will-you-handle-batch-insert-in-hibernate-for-optimal-usage-of-memory-network-and-cpu)
95. [what-are-different-types-of-http-status-codes](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-different-types-of-http-status-codes)
96. [what-is-inversion-of-control-or-dependency-injection](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-inversion-of-control-or-dependency-injection)
97. [what-are-new-features-added-in-java-8](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-are-new-features-added-in-java-8)
98. [can-the-keys-in-hashing-data-structure-be-made-mutable](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-can-the-keys-in-hashing-data-structure-be-made-mutable)
99. [what-is-the-the-default-security-configuration-and-how-we-can-disable-or-customize](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-the-the-default-security-configuration-and-how-we-can-disable-or-customize)
100. [discuss-comparable-and-comparator-which-one-should-be-used](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-discuss-comparable-and-comparator-which-one-should-be-used-in-a-given-scenario)
101. [what-is-difference-between-sleep-yield-and-wait-method](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-what-is-difference-between-sleep-yield-and-wait-method)
102. [string-class-to-be-immutable](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
103. [single-instance-should-run-for-that-application](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
104. [data-structure-and-usages](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
105. [prevent-breaking-a-singleton-class-pattern](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
106. [print-second-highest-number-from-stream](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
107. [what-is-optional-and-what-is-it-best-used-for](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
108. [pessimistic-approach-and-optimistic-approach-in-dbms](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
109. [the-contract-between-equals-and-hashcode-methods-in-java](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
110. [equals-method-is-overridden-without-overriding-hashcode-or-vice-versa](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-if-the-equals-method-is-overridden-without-overriding-hashcode-or-vice-versa)
...
4. [load-a-big-trnsactional-file-and-fetch-the-trnasction-records-using-best-data-structures](https://github.com/emranxec/KeepLearning/blob/main/README.md#q-load-a-big-trnsactional-file-and-fetch-the-trnasction-records-using-best-data-structures)
